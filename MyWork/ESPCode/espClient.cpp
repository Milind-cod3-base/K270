...
void loop() {
    // Receive data from STM32 over USART
...
// Below code is only useful if esp is packaging all the sensors data into json object, but since stm is doing it, no need.
